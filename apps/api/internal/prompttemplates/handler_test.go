...
func setupRouter(t *testing.T, svc promptTemplateServicer) (*gin.Engine, *auth.JWTManager, uuid.UUID) {
	t.Helper()
...
func TestCreatePromptTemplateRequiresAuth(t *testing.T) {
	r, _, _ := setupRouter(t, newFakePromptTemplateService())
